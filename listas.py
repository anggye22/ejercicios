...
copia_lista.append([-1,-2,-3]) #Agrega estos elementos a la lista como una sublista
print("Después de append([-1,-2,-3]):", copia_lista)
copia_lista.extend([4,5,6]) #Agrega elementos a la lista de forma independiente
print("Después de extend([4,5,6]):", copia_lista)
lista2=list(range(5)) #Genera una serie de números automáticos
